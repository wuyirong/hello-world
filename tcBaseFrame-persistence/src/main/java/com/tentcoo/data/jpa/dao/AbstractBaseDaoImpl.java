package com.tentcoo.data.jpa.dao;
...
import com.tentcoo.data.jpa.dto.Order;
import com.tentcoo.data.jpa.dto.QueryResult;
import com.tentcoo.data.jpa.exception.DaoException;
import com.tentcoo.data.jpa.util.EntityUtils;
...
//	protected Logger LOG = LoggerFactory.getLogger(getClass());
	...
	public java.util.Map queryMapByJdbc(String sql, String[] params){
		...
		if(list!=null && !list.isEmpty()){
			java.util.Map objMap = (java.util.Map)list.get(0);
			return objMap;
		}else{
			return null;
		}
