 ...
 * see http://blog.csdn.net/lhc1105/article/details/78399955
 */
@Component
public class JwtUtil {
    ...
    public String generateToken(String userAccount) {
        ...
        claims.put(CLAIM_KEY_USER_ACCOUNT, userAccount);
...
//        JwtUser user = (JwtUser) userDetails;
        ...
        //final Date created = getCreatedDateFromToken(token);
        return useraccount.equals(userAccount) && !isTokenExpired(token);
    }
