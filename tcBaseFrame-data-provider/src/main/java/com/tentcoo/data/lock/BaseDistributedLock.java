...
public class BaseDistributedLock {
    ...
    private String createLockNode(ZkClientExt client, String path) throws Exception  {
        return client.createEphemeralSequential(path, new byte[0]);//null
        //return client.createPersistentSequential(path, new byte[0]);
